...
export function buildMagazineDiscoveryCard({
  domain_manifest,
  surface_manifest,
  shared_projection,
  retained_extras,
  ...
  return createDiscoveryCardSurface({
    ...
    eyebrow: visible_extras.issue_label || "Magazine",
    badges: [visible_extras.cover_slot, list_item.update_type].filter(Boolean),
