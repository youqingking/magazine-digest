...
import { projectDirectYoutubeSummary } from "./project-direct-youtube-summary.js";

export function runDirectYoutubeSummary(raw_input = {}) {
  ...
  const shared_projection = projectDirectYoutubeSummary(raw_input);
  ...
  const diagnostics = buildPilotDiagnostics({
    ...
    additional_notes: ["Step 06 direct YouTube adoption executed through shared runtime."]
  });
