#!/usr/bin/env python3
"""Run the screenshot-capture-agent validator from the launch boundary."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate screenshot-capture-agent outputs.")
