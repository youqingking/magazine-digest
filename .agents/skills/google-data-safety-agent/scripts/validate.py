#!/usr/bin/env python3
"""Run the google-data-safety-agent validator from the launch boundary."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate google-data-safety-agent outputs.")
